...
fun main() {
    ...
    val test1 = execDay9 ("109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99".split(",").map { it.toLong() })
    val test2 = execDay9 ("1102,34915192,34915192,7,4,7,99,0".split(",").map { it.toLong() })
    val test3 =  execDay9 ("104,1125899906842624,99".split(",").map { it.toLong() })
